...
namespace NAudio.Midi
{
    ...
    public class RawMetaEvent : MetaEvent
    {
        ...
        /// </summary>
        public RawMetaEvent(MetaEventType metaEventType, long absoluteTime, byte[] data) : base(metaEventType, absoluteTime)
        {
            Data = data;
        }
        ...
        /// </summary>
        protected override int ExportLength => Data?.Length ?? 0;
